...
public class RobotMap {
    ...
    public static Encoder armSubsystemArmEncoder;
    public static DigitalInput armSubsystemMaximumArmHeightSwitch;
    public static DigitalInput armSubsystemMinimumArmHeightSwitch;
    public static SpeedController armSubsystemArmMotorController;
    ...
    public static void init() {
        ...
        driveSubsystemLeftDriveEncoder = new Encoder(2, 3, false, EncodingType.k4X);
        ...
        driveSubsystemRightDriveEncoder = new Encoder(0, 1, false, EncodingType.k4X);
        ...
        armSubsystemArmEncoder = new Encoder(4, 5, false, EncodingType.k4X);
        LiveWindow.addSensor("ArmSubsystem", "ArmEncoder", armSubsystemArmEncoder);
        armSubsystemArmEncoder.setDistancePerPulse(1.0);
        armSubsystemArmEncoder.setPIDSourceType(PIDSourceType.kRate);
        armSubsystemMaximumArmHeightSwitch = new DigitalInput(8);
        LiveWindow.addSensor("ArmSubsystem", "MaximumArmHeightSwitch", armSubsystemMaximumArmHeightSwitch);
        
        armSubsystemMinimumArmHeightSwitch = new DigitalInput(9);
        LiveWindow.addSensor("ArmSubsystem", "MinimumArmHeightSwitch", armSubsystemMinimumArmHeightSwitch);
        
        armSubsystemArmMotorController = new Talon(5);
        LiveWindow.addActuator("ArmSubsystem", "ArmMotorController", (Talon) armSubsystemArmMotorController);
